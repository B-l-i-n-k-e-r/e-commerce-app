...
@section('content')
    <div class="min-h-screen flex flex-col justify-center py-12 px-6 lg:px-8 bg-gray-50 dark:bg-gray-950">
        ...
        <div class="sm:mx-auto sm:w-full sm:max-w-[440px]">
            <x-card title="Update Credentials" subtitle="Finalize your account restoration">
                ...
                <form method="POST" action="{{ route('password.store') }}" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <input 
                            ...
                            required 
                            readonly
                            class="w-full bg-gray-100 dark:bg-gray-900/50 border-none rounded-2xl py-4 px-5 text-sm text-gray-500 dark:text-gray-400 cursor-not-allowed transition-all"
                        >
